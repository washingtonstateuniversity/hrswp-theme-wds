<?php
/**
 * Title: Site Footer Content
 * Slug: hrswds/site-footer-content
 * Categories: footer
 * Block Types: hrswds/template-part/site-footer
 *
 * @package HRSWP_ThemeWDS
 */

namespace HRSWP\Theme\WDS\Patterns\SiteFooterContent;

?>
<!-- wp:paragraph -->
	<p>
		<?php
		echo '<svg aria-hidden="true" tabindex="-1" role="img" aria-labelledby="wsuLogoTitle wsuLogoDesc" class="wsu-coug-head wsu-coug-head--white" enable-background="new 0 0 70.2 69.6" version="1.1" viewBox="0 0 70.2 69.6" xml:space="preserve" xmlns="http://www.w3.org/2000/svg">
