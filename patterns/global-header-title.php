 ...
 * Slug: hrswds/global-header-title
 * Categories: header
 * Block Types: hrswds/template-part/header
 *
...
<!-- wp:paragraph -->
	<p>
		<?php
		echo '<a class="wsu-wordmark" href="https://wsu.edu" aria-label="Go to ' . esc_attr( $header_title ) . ' Homepage">
			...
			<span class="wsu-wordmark__title">' . esc_html( $header_title ) . '</span>
			<span class="wsu-wordmark__title-mobile">WSU</span>
		</a>';
		?>
	</p>
<!-- /wp:paragraph -->
