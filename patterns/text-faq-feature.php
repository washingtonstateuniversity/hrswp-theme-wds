...
namespace HRSWP\Theme\WDS\Patterns\TextFaqFeature;

?>

<!-- wp:group {"metadata":{"name":"<?php echo esc_html_x( 'FAQs feature', 'Name of the FAQ pattern', 'hrswp-theme-wds' ); ?>"},"align":"full","style":{"elements":{"link":{"color":{"text":"var:preset|color|base"}}}},"backgroundColor":"contrast","textColor":"base","layout":{"type":"constrained"}} -->
<div class="wp-block-group alignfull has-base-color has-contrast-background-color has-text-color has-background has-link-color">
	<!-- wp:heading {"align":"wide","className":"is-style-default","fontSize":"xx-large"} -->
	<h2 class="wp-block-heading alignwide is-style-default has-xx-large-font-size"><?php echo esc_html_x( 'FAQs', 'Heading of the FAQs', 'hrswp-theme-wds' ); ?></h2>
	<!-- /wp:heading -->

	<!-- wp:group {"align":"wide","layout":{"type":"default"}} -->
	<div class="wp-block-group alignwide">
		<!-- wp:separator {"backgroundColor":"secondary-light","className":"is-style-wide"} -->
		<hr class="wp-block-separator has-text-color has-secondary-light-color has-alpha-channel-opacity has-secondary-light-background-color has-background is-style-wide"/>
		<!-- /wp:separator -->
